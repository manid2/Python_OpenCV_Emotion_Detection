...
__original_author__ = "Paul van Gent, 2016"
__author__ = "Mani Kumar D A, 2017"

""" 
Mani experimenting with facial information extraction.

@purpose: To extract all possible information from an image
          and present it in json format for further processing.
...
def get_landmarks(image):
    ...
    for k,d in enumerate(detections):
        ...
        if xlist[26] == xlist[29]:
            ...
            radians = math.atan( (ylist[26]-ylist[29]) / 
                                 (xlist[26]-xlist[29]) )
            # since degrees = radians * rad2deg_const_factor
            anglenose = int(radians * rad2deg_const_factor)
            # END - Mani refactor
